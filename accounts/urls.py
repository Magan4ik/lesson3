...
urlpatterns = [
    ...
    path('login/sendemail/', views.send_email_view, name='send_email'),
    path('login/verifyemail/<str:username>/', views.verify_email_view, name='verify_email'),
    path('login/setpassword/<str:username>/', views.set_password_view, name='set_password'),
